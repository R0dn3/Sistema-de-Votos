...
import LibreriaReportesTablasHash.GeneradorReportesTablasHash;
import javax.swing.table.DefaultTableModel;

public class ReporteVotosTablasHash extends javax.swing.JFrame {

    // Declarar la variable generadorReportes de tipo GeneradorReportes
    private GeneradorReportesTablasHash generadorReportes;

    /**
     * Constructor de la clase ReporteVotos. Inicializa los componentes de la
     * interfaz gráfica y la variable generadorReportes.
     */
    public ReporteVotosTablasHash() {
        initComponents(); // Llama al método para inicializar los componentes de la interfaz gráfica
        generadorReportes = new GeneradorReportesTablasHash(); // Inicializar la variable generadorReportes
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte Votos Tablas Hash");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteVotosTablasHash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReporteVotosTablasHash().setVisible(true);
            }
        });
    }
